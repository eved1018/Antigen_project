...
import pandas as pd
import re
folder = Path("/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/method_clustering_analysis/test_data_sppider_unbound/patches")
                    ...
                    with open ("/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/ispred/unbound_ispred_fscores.txt") as infile_3:
                        for tonka in infile_3:
                            ...
                            if protein == file.name[:4]:
                                ...
                                with open ("/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/Spidder/unbound_data/f_score_per_protein.txt") as infile_4:
                                    for tonka_1 in infile_4:
                                        protein_1 = tonka_1.strip().split(",")[0]
                                        if protein_1 == file.name[:4]:
                                            old_fscore = tonka_1.strip().split(",")[1]
