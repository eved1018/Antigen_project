            ...
            with open(file) as file_bound:
                ...
                for i in CoList:
                    if i:
                        Counter += 1
                cookie = Counter
                print(f"{file.name[-23:-14]},170,15,{cookie}")
                with open(f"/Users/moshe/Desktop/Research_Antigen/Vorffip/fake_cutoffs_unbound.csv", 'a') as f:
                    f.write(f"{file.name[-23:-14]},170,15,{cookie} \n")