...
#fix ispred folder
folder = Path("/Users/moshe/Desktop/Research_Antigen/ispred/ispred_returned_pdbs/Bound_Results") # designate the folder with all the files
    ...
    for file in folder_11.iterdir():
        if file.name.endswith("_pdb_download.pdb"):
            ...
            with open(file) as file_annotated:
                protein_name = file.name[:4] #check
                for line in file_annotated:
                    if line.startswith("ATOM"):
                        ...
                        with open(f"/Users/moshe/Desktop/Research_Antigen/ispred/ispred_bound_results_pdb/{protein_name}_ispred_results.txt", 'a') as f:
