...
folder = Path("/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/cv_unbound_sets/edited_new_49_bound_pdbs")
for file in folder.iterdir():
    if str(file).endswith(".pdb"):
        chain = file.name.split(".")[1]
        
        pipe = subprocess.Popen(["perl", "extractSeqPDB.pl", file, chain])
