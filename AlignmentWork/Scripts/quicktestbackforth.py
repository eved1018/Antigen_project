...
def get_annotated_num():
    with open("/Users/moshe/Desktop/Research_Antigen/Updated_PDBs_and_Data/antigen_complexed/annotated_results_updated/5E8E.H.txt") as annoted_num_file: #annotated_results_6_column
...
def find_corresponding_unbound_pos_num():
    with open("/Users/moshe/Desktop/Research_Antigen/AlignmentWork/PerlScripts/testmsa.aln") as alignment_file: #msa2colum, pos0 ... pos1...
...
def try1():
    list1=[]
    with open("/Users/moshe/Desktop/Research_Antigen/AlignmentWork/PerlScripts/5E8E.map") as pos_res_file_name: #bound .map file
        ...
        for line in file_text:
            ...
            if res_num in get_annotated_num():
                ...
                #print(pos_num)
                with open("/Users/moshe/Desktop/Research_Antigen/AlignmentWork/PerlScripts/testmsa.aln") as alignment_file:
                    alignment_text = str(alignment_file.read()).split("\n")
                    bound_pos_num = ""
                    unbound_pos_num = ""
                    list_bound_and_unbound_pos_num = []
                                ...
                                for line in unbound_map_text:
                                    ...
                                    try:
                                        ...
                                        if unbound_pos_num == unbound_pos_num_map and unbound_one_letter_AA == one_letter_AA:
                                            return unbound_res_num_map, unbound_three_letter_AA
                                    except IndexError:
                                        pass

with open(Path(f"/Users/moshe/Desktop/Research_Antigen/AlignmentWork/PerlScripts/5edk/test11.txt"),
    'w', newline="\n") as outfile:
    outfile.write(str(try1()))
