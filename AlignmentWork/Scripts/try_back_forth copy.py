...
def get_annotated_num():
    with open("/Users/moshe/Desktop/Research_Antigen/Updated PDBs and Data/antigen_complexed/annotated_results_updated/5E8E.H.txt") as annoted_num_file:
...
with open("/Users/moshe/Desktop/Research_Antigen/AlignmentWork/PerlScripts/5E8E.map") as pos_res_file_name:
            ...
            with open("/Users/moshe/Desktop/Research_Antigen/AlignmentWork/PerlScripts/testmsa.aln") as alignment_file:
                ...
                for line in alignment_text:
                    ...
                    if pos_num == bound_pos_num:
                        ...
                        with open("/Users/moshe/Desktop/Research_Antigen/AlignmentWork/PerlScripts/5edk.txt") as unbound_map_file:
                            ...
                            for line in unbound_map_text:
                                ...
                                try:
                                    ...
                                    if unbound_pos_num == unbound_pos_num_map:
