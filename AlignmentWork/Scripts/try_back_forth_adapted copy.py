                            ...
                            with open(unbound_map) as unbound_map_file: #unbound .map file
                                ...
                                for line in unbound_map_text:
                                    ...
                                    try:
                                        ...
                                        pass
    df=pd.from_dict(results_dic, columns=["unbound_res_num_map", "unbound_three_letter_AA"])
        
    df.to_csv("/Users/moshe/Desktop/Research_Antigen/AlignmentWork/Scripts/1FE8TEST/testalt_pandas.csv")
