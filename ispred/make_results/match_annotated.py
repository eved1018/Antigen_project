...
vorffip_folder = Path("/Users/moshe/Desktop/Research_Antigen/Meta-ppisp_copy/unboundresults")
for file in vorffip_folder.iterdir():
    with open(file) as vorffip_file:
        # vorffip_protein_name1 = file.name[:4]
                    ...
                    with open(item) as annotated_file:
                        for line1 in annotated_file:
                            ...
                            if annotated_res_num== vorffip_res:
                                ...
                                with open(f"/Users/moshe/Desktop/Research_Antigen/Meta-ppisp_copy/unbound_metappisp_annotated/{ann_protein_name}_metappisp_unbound_results_with_annotated.txt", 'a') as f:
                                    f.write(f"{line.strip()},{if_annotated.strip()} \n")
