...
df = pd.read_csv("/Users/moshe/Desktop/Research_Antigen/ispred/finalized_bound_ispred_results.txt")
...
for predictor in predictors:
    for protein in proteins:
        ...
        # with open(f"/Users/moshe/Desktop/Research_Antigen/clustering/predicted_vorffip_annotated/{protein}_vorffip_20_predicted.txt", 'a') as f:
