...
for file_starter in path_starter.iterdir():
    ...
    os.mkdir(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/clustering_analysis/1_script_attempt/data_bound/{predictor}/kmeans_cluster_3")
    os.mkdir(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/clustering_analysis/1_script_attempt/data_bound/{predictor}/kmeans_cluster_4")
    os.mkdir(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/clustering_analysis/1_script_attempt/data_bound/{predictor}/kmeans_cluster_5")
            ...
            with open (cutoff_path) as infile_4:
                for fire_medic in infile_4:
                    if fire_medic.strip().split(",")[0] == protein_name:
                        ...
                        with open (f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/clustering_analysis/1_script_attempt/data_bound/{predictor}/kmeans_cluster_3/{protein_name}_{predictor}.txt", "a") as outfile_3:
                            outfile_3.write(f"{string_clu3}")
                        with open (f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/clustering_analysis/1_script_attempt/data_bound/{predictor}/kmeans_cluster_4/{protein_name}_{predictor}.txt", "a") as outfile_4:
                            outfile_4.write(f"{string_clu4}")
                        with open (f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/clustering_analysis/1_script_attempt/data_bound/{predictor}/kmeans_cluster_5/{protein_name}_{predictor}.txt", "a") as outfile_5:
    ...
    folder_cluster_1 = Path(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/clustering_analysis/1_script_attempt/data_bound/{predictor}/kmeans_cluster_3")
    folder_2 = Path("/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/bound_pdbs_and_annotated_residue_data/bound_annotated_results copy")
            ...
            with open ("/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/detailed_individual_method_data/ispred/bound_ispred_fscores.txt") as infile_3:
                for tonka in infile_3:
                    ...
                    if protein == protein_name_1:
                        ...
                        print(f"{protein},{fscore},{len(combined_list_final)},{tot_TP}")
                        with open(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/clustering_analysis/1_script_attempt/data_bound/{predictor}/cluster_3_outfile.csv", "a") as outfile:
                            outfile.write(f"{protein},{fscore},{len(combined_list_final)},{tot_TP}\n")




    folder_cluster_1 = Path(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/clustering_analysis/1_script_attempt/data_bound/{predictor}/kmeans_cluster_4")
    folder_2 = Path("/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/bound_pdbs_and_annotated_residue_data/bound_annotated_results copy")
            ...
            with open ("/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/detailed_individual_method_data/ispred/bound_ispred_fscores.txt") as infile_3:
                for tonka in infile_3:
                    ...
                    if protein == protein_name_1:
                        ...
                        print(f"{protein},{fscore},{len(combined_list_final)},{tot_TP}")
                        with open(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/clustering_analysis/1_script_attempt/data_bound/{predictor}/cluster_4_outfile.csv", "a") as outfile:
                            outfile.write(f"{protein},{fscore},{len(combined_list_final)},{tot_TP}\n")



    folder_cluster_1 = Path(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/clustering_analysis/1_script_attempt/data_bound/{predictor}/kmeans_cluster_5")
    folder_2 = Path("/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/bound_pdbs_and_annotated_residue_data/bound_annotated_results copy")
            ...
            with open ("/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/detailed_individual_method_data/ispred/bound_ispred_fscores.txt") as infile_3:
                for tonka in infile_3:
                    ...
                    if protein == protein_name_1:
                        ...
                        print(f"{protein},{fscore},{len(combined_list_final)},{tot_TP}")
                        with open(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/clustering_analysis/1_script_attempt/data_bound/{predictor}/cluster_5_outfile.csv", "a") as outfile:
                            outfile.write(f"{protein},{fscore},{len(combined_list_final)},{tot_TP}\n")
