...
annotated_folder = Path(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/clustering_analysis/data_bound/{predictor}/")
#on github -- bound/unbound
                                    ...
                                    with open(item_1) as annotated_file:
                                        for line1 in annotated_file:
                                            ...
                                            if (str(annotated_res_num) == str(res_num)):
                                                ...
                                                with open(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/clustering_analysis/data_bound/{predictor}/{item.name}/predicted_residues/{res_num}.txt", 'a') as f:
