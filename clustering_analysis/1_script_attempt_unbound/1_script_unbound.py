...
df = pd.read_csv("/Users/moshe/Desktop/Research_MetaDPI/MetaDPIv2-main/metadpi/output/unbound_test/bin_frame.csv")
...
path_starter = Path("/Users/moshe/Desktop/Research_MetaDPI/MetaDPIv2-main/metadpi/output/unbound_test/fscore_by_method")
for file_starter in path_starter.iterdir():
    ...
    annotated_folder = Path(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/clustering_analysis/1_script_attempt_unbound/data_unbound/{predictor}/")
    #on github -- bound/unbound
                                        ...
                                        with open(item_1) as annotated_file:
                                            for line1 in annotated_file:
                                                ...
                                                if (str(annotated_res_num) == str(res_num)): #change between pred and annotated
                                                    with open(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/clustering_analysis/1_script_attempt_unbound/data_unbound/{predictor}/{item.name}/predicted_residues/{res_num}.txt", 'a') as f:
                                                        f.write(f"{atom_name},{res_name},{res_num},{xcoordinated},{ycoordinated},{zcoordinated}\n")



    folder_infile_1 = Path(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/clustering_analysis/1_script_attempt_unbound/data_unbound/{predictor}")
            ...
            with open ("/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/cutoffs/unbound_cutoff.csv") as infile_4:
                for fire_medic in infile_4:
                    if fire_medic.strip().split(",")[0] == protein_name:
                        ...
                        with open (f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/clustering_analysis/1_script_attempt_unbound/data_unbound/{predictor}/kmeans_cluster_1/{protein_name}_{predictor}.txt", "a") as outfile_1:
    ...
    folder = Path(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/clustering_analysis/1_script_attempt_unbound/data_unbound/{predictor}")    
    ...
    folder_cluster_1 = Path(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/clustering_analysis/1_script_attempt_unbound/data_unbound/{predictor}/kmeans_cluster_1")
            ...
            with open ("/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/detailed_individual_method_data/ispred/unbound_ispred_fscores.txt") as infile_3:
                for tonka in infile_3:
                    ...
                    if protein == protein_name_1:
                        ...
                        with open(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/clustering_analysis/1_script_attempt_unbound/data_unbound/{predictor}/cluster_1_outfile.csv", "a") as outfile:
                            outfile.write(f"{protein},{fscore},{len(combined_list_final)},{tot_TP}\n")




    folder_cluster_1 = Path(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/clustering_analysis/1_script_attempt_unbound/data_unbound/{predictor}/kmeans_cluster_2")
    folder_2 = Path("/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/unbound_pdbs_and_annotated_residue_data/unbound_annotated_results_copy")
            ...
            with open ("/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/detailed_individual_method_data/ispred/unbound_ispred_fscores.txt") as infile_3:
                for tonka in infile_3:
                    ...
                    if protein == protein_name_1:
                        ...
                        print(f"{protein},{fscore},{len(combined_list_final)},{tot_TP}")
                        with open(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/clustering_analysis/1_script_attempt_unbound/data_unbound/{predictor}/cluster_2_outfile.csv", "a") as outfile:
                            outfile.write(f"{protein},{fscore},{len(combined_list_final)},{tot_TP}\n")
...
#9
    ...
    mcc_final = mcc_tot/i
    with open ("/Users/moshe/Desktop/Research_MetaDPI/MetaDPIv2-main/metadpi/output/unbound_test/clustering_results.txt", "a") as f1:
