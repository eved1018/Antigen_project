        ...
        with open ("/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/ispred/unbound_cutoff copy.csv") as infile_4:
            for fire_medic in infile_4:
                if fire_medic.strip().split(",")[0] == protein_name:
                    ...
                    with open (f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/distance_clustering/testing_ispred_unbound_separate/cluster_lists_k_means/cluster_1/{protein_name}_ispred_cluster_1", "a") as outfile_1:
                        outfile_1.write(f"{string_clu1}")
                    with open (f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/distance_clustering/testing_ispred_unbound_separate/cluster_lists_k_means/cluster_2/{protein_name}_ispred_cluster_2", "a") as outfile_1:
