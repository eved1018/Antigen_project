...
with open(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/clustering_analysis/data_unbound/{predictor}/merged_cluster_outfile.csv") as infile_1:
    for line in infile_1:
        ...
        if ((cluster_1_tp == 0) and (cluster_2_tp == 0)):
            with open (f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/clustering_analysis/data_unbound/{predictor}/zero_tp_both_clusters.csv", "a") as outfile_1:
                outfile_1.write(f"{line.strip()}\n")
        
        #2
        if ((cluster_2_tp != 0) and (cluster_1_tp == 0)) or ((cluster_1_tp != 0) and (cluster_2_tp == 0)):
            if cluster_2_tp !=0:
                with open (f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/clustering_analysis/data_unbound/{predictor}/only_one_cluster_nonzero_tp.csv", "a") as outfile_2:
                    outfile_2.write(f"{protein_1},{fscore_cluster_2},{cluster_2_size},{cluster_2_tp},clusters:2\n")
            if cluster_1_tp !=0:
                with open (f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/clustering_analysis/data_unbound/{predictor}/only_one_cluster_nonzero_tp.csv", "a") as outfile_3:
            ...
            with open (f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/Unbound_predictor_results/fscores/{predictor}_unbound.csv") as infile_fscore:
                for item in infile_fscore:
                    if str(item.strip().split(",")[0]) == str(protein_1):
                        ...
                        with open (f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/clustering_analysis/data_unbound/{predictor}/both_clusters_nonzero_tp_below_23A.csv", "a") as outfile_4:
        ...
        if ((cluster_2_tp != 0) and (cluster_1_tp != 0) and distance > 23):
            if cluster_2_size > cluster_1_size:
                with open (f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/clustering_analysis/data_unbound/{predictor}/both_clusters_nonzero_tp_above_23A.csv", "a") as outfile_5:
                    outfile_5.write(f"{protein_1},{fscore_cluster_2},{cluster_2_size},{cluster_2_tp},clusters:2\n")                
            
            if cluster_1_size > cluster_2_size:
                with open (f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/clustering_analysis/data_unbound/{predictor}/both_clusters_nonzero_tp_above_23A.csv", "a") as outfile_6:
                    outfile_6.write(f"{protein_1},{fscore_cluster_1},{cluster_1_size},{cluster_1_tp},clusters:1\n")                

            if cluster_1_size == cluster_2_size:
                if cluster_1_tp > cluster_2_tp:
                    with open (f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/clustering_analysis/data_unbound/{predictor}/both_clusters_nonzero_tp_above_23A.csv", "a") as outfile_7:
                        outfile_7.write(f"{protein_1},{fscore_cluster_1},{cluster_1_size},{cluster_1_tp},clusters:1\n")
                if cluster_2_tp > cluster_1_tp:
                    with open (f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/clustering_analysis/data_unbound/{predictor}/both_clusters_nonzero_tp_above_23A.csv", "a") as outfile_8:
                        outfile_8.write(f"{protein_1},{fscore_cluster_2},{cluster_2_size},{cluster_2_tp},clusters:2\n")                
             
             
filenames = [f'/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/clustering_analysis/data_unbound/{predictor}/both_clusters_nonzero_tp_above_23A.csv', f'/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/clustering_analysis/data_unbound/{predictor}/both_clusters_nonzero_tp_below_23A.csv', f'/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/clustering_analysis/data_unbound/{predictor}/only_one_cluster_nonzero_tp.csv']
with open(f'/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/clustering_analysis/data_unbound/{predictor}/summary_file.csv', 'w') as outfile:
...
total_predicted = 0
total_annotated = 0
with open (f'/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/clustering_analysis/data_unbound/{predictor}/summary_file.csv') as infile_3:
