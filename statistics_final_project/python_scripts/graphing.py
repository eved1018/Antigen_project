...
def pymol_viz(bin_frame, proteins, predicted_col, annotated_col, pymolscriptpath, output_path_dir):
    ...
    for protein in proteins:
        ...
        for pred in predicted_col:
            ...
            tp_residues = tp_residues + "+10000000"
            print(tp_residues, protein, pred)
            ...
            subprocess.run(
                f"/Applications/PyMOL.app/Contents/MacOS/PyMOL -Q -c -q  {pymolscriptpath} -- {output_path_dir} {protein} {tp_residues} {fp_residues} {annotated_resiues} {pred}", shell=True)
