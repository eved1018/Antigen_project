...
folder_pred = Path("/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/method_clustering_analysis/test_data_ispred_unbound/patch_predicted_residues")
...
def test():
    ...
    results_path = "/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/method_clustering_analysis/images_center"
    code = 1
...
def Main(predictors,df,results_path,code):
    ...
    results_folder = "/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/method_clustering_analysis/images_center"
...
def pml_predicted(protein,cutoff_csv,df,predictor):
    ...
    for tonka in folder_pred.iterdir():
        if protein == tonka.name[:4]:
            with open (tonka) as infile_pred:
                pred_res_list = str(infile_pred.readlines()).strip()
