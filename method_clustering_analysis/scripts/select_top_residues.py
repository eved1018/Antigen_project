...
def Main():
    predictors = ['ispred']
    path ="/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/Unbound_predictor_results/unbound_ispred.txt"
...
def Run(params): 
    ...
    for i in predicted_res: 
        ...
        res = res_prot[0]
        pred_res.append(res)
    with open (f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/method_clustering_analysis/test_data_ispred_unbound/predicted_residues/{protein}_{predictor}_predicted_residues.txt", "a") as outfile:
        outfile.write("\n".join(pred_res))
