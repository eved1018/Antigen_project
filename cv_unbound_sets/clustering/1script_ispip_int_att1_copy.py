...
cutoff_path = "/Users/moshe/Desktop/Research_MetaDPI/ISPIP-main/Data/input/unbound_cutoff_2_23.csv"
...
for file_starter in path_starter.iterdir():
    ...
    os.mkdir(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/cv_unbound_sets/clustering/results/{predictor}")
    ...
    for item_predictor in predictors:
        for protein in proteins:
            try:
                ...
                os.mkdir(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/cv_unbound_sets/clustering/results/{predictor}/{protein}")
                os.mkdir(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/cv_unbound_sets/clustering/results/{predictor}/{protein}/predicted_residues/")

                with open(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/cv_unbound_sets/clustering/results/{predictor}/{protein}/{protein}_unbound_predicted_residues.txt", 'a') as f:
    ...
    pdb_folder = Path("/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/cv_unbound_sets/49_unbound_pdbs")
    #on github -- bound/unbound
    annotated_folder = Path(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/cv_unbound_sets/clustering/results/{predictor}/")
    #on github -- bound/unbound
                                        ...
                                        with open(item_1) as annotated_file:
                                            for line1 in annotated_file:
                                                ...
                                                if (str(annotated_res_num) == str(res_num)):
                                                    ...
                                                    with open(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/cv_unbound_sets/clustering/results/{predictor}/{item.name}/predicted_residues/{res_num}.txt", 'a') as f:
                                                        f.write(f"{atom_name},{res_name},{res_num},{xcoordinated},{ycoordinated},{zcoordinated}\n")

    folder_infile_1 = Path(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/cv_unbound_sets/clustering/results/{predictor}")
    ...
    os.mkdir(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/cv_unbound_sets/clustering/results/{predictor}/kmeans_cluster_1")
    os.mkdir(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/cv_unbound_sets/clustering/results/{predictor}/kmeans_cluster_2")
    os.mkdir(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/cv_unbound_sets/clustering/results/{predictor}/kmeans_cluster_3")
    os.mkdir(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/cv_unbound_sets/clustering/results/{predictor}/kmeans_cluster_4")
    os.mkdir(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/cv_unbound_sets/clustering/results/{predictor}/kmeans_cluster_5")
            ...
            with open (cutoff_path) as infile_4:
                for fire_medic in infile_4:
                    if fire_medic.strip().split(",")[0] == protein_name:
                        ...
                        with open (f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/cv_unbound_sets/clustering/results/{predictor}/kmeans_cluster_1/{protein_name}_{predictor}.txt", "a") as outfile_1:
                            outfile_1.write(f"{string_clu1}")
                        with open (f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/cv_unbound_sets/clustering/results/{predictor}/kmeans_cluster_2/{protein_name}_{predictor}.txt", "a") as outfile_2:
                            outfile_2.write(f"{string_clu2}")
                        with open (f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/cv_unbound_sets/clustering/results/{predictor}/kmeans_cluster_3/{protein_name}_{predictor}.txt", "a") as outfile_3:
                            outfile_3.write(f"{string_clu3}")
                        with open (f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/cv_unbound_sets/clustering/results/{predictor}/kmeans_cluster_4/{protein_name}_{predictor}.txt", "a") as outfile_4:
                            outfile_4.write(f"{string_clu4}")
                        with open (f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/cv_unbound_sets/clustering/results/{predictor}/kmeans_cluster_5/{protein_name}_{predictor}.txt", "a") as outfile_5:
                            outfile_5.write(f"{string_clu5}")
                        with open(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/cv_unbound_sets/clustering/results/{predictor}/{predictor}_kmeans_clustering_results.csv", "a") as outfile:
    ...
    folder = Path(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/cv_unbound_sets/clustering/results/{predictor}")    
    ...
    folder_cluster_1 = Path(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/cv_unbound_sets/clustering/results/{predictor}/kmeans_cluster_1")
    folder_2 = Path("/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/cv_unbound_sets/alignment/unbound_annotations")
    ...
    for file_1 in folder_cluster_1.iterdir():
        ...
        with open(file_1) as infile_1:
            ...
            for item in folder_2.iterdir():
                if item.name[5:9] == protein_name_1:
            ...
            with open ("/Users/moshe/Desktop/Research_MetaDPI/ISPIP-main/Data/input/unbound_cutoff_2_23.csv") as infile_3:
                for tonka in infile_3:
                    protein = tonka.strip().split(",")[0]
                    if protein == protein_name_1:
                        tot_annotated = tonka.strip().split(",")[3]
                        ...
                        with open(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/cv_unbound_sets/clustering/results/{predictor}/cluster_1_outfile.csv", "a") as outfile:
                            outfile.write(f"{protein},{fscore},{len(combined_list_final)},{tot_TP}\n")


    #5b

    folder_cluster_3 = Path(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/cv_unbound_sets/clustering/results/{predictor}/kmeans_cluster_2")
    folder_3 = Path("/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/cv_unbound_sets/alignment/unbound_annotations")

    for file_2 in folder_cluster_3.iterdir():
        protein_name_2 = file_2.name[:4]
        combined_list_final = []
        tot_TP = 0
        with open(file_2) as infile_2:
            for line_2 in infile_2:
                cluster_2_predicted_residue = (line_2.strip()[:-5])
                combined_list_final.append(cluster_2_predicted_residue)

            for item in folder_3.iterdir():
                if item.name[5:9] == protein_name_2:
                    for i3 in combined_list_final:
                        with open (item) as infile_3:
                            for line_3 in infile_3:
                                if str(i3.strip()) == str(line_3.strip().split(" ")[0]):

                                    tot_TP = tot_TP + 1
                    #fix this


            with open ("/Users/moshe/Desktop/Research_MetaDPI/ISPIP-main/Data/input/unbound_cutoff_2_23.csv") as infile_4:
                for tonka in infile_4:
                    protein = tonka.strip().split(",")[0]
                    if protein == protein_name_2:
                        tot_annotated = tonka.strip().split(",")[3]
                        ...
                        print(f"{protein},{fscore},{len(combined_list_final)},{tot_TP}")
                        with open(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/cv_unbound_sets/clustering/results/{predictor}/cluster_2_outfile.csv", "a") as outfile:
                            outfile.write(f"{protein},{fscore},{len(combined_list_final)},{tot_TP}\n")



    folder_cluster_3 = Path(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/cv_unbound_sets/clustering/results/{predictor}/kmeans_cluster_3")
    folder_4 = Path("/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/cv_unbound_sets/alignment/unbound_annotations")

    for file_3 in folder_cluster_3.iterdir():
        protein_name_3 = file_3.name[:4]
        combined_list_final = []
        tot_TP = 0
        with open(file_3) as infile_3:
            for line_3 in infile_3:
                cluster_3_predicted_residue = (line_3.strip()[:-5])
                combined_list_final.append(cluster_3_predicted_residue)

            for item in folder_3.iterdir():
                if item.name[5:9] == protein_name_3:
                    for i4 in combined_list_final:
                        with open (item) as infile_4:
                            for line_4 in infile_4:
                                if str(i4.strip()) == str(line_4.strip().split(" ")[0]):

                                    tot_TP = tot_TP + 1
                    #fix this


            with open ("/Users/moshe/Desktop/Research_MetaDPI/ISPIP-main/Data/input/unbound_cutoff_2_23.csv") as infile_5:
                for tonka in infile_5:
                    protein = tonka.strip().split(",")[0]
                    if protein == protein_name_3:
                        tot_annotated = tonka.strip().split(",")[3]
                        ...
                        print(f"{protein},{fscore},{len(combined_list_final)},{tot_TP}")
                        with open(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/cv_unbound_sets/clustering/results/{predictor}/cluster_3_outfile.csv", "a") as outfile:
                            outfile.write(f"{protein},{fscore},{len(combined_list_final)},{tot_TP}\n")




    folder_cluster_1 = Path(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/cv_unbound_sets/clustering/results/{predictor}/kmeans_cluster_4")
    folder_2 = Path("/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/cv_unbound_sets/alignment/unbound_annotations")
            ...
            with open ("/Users/moshe/Desktop/Research_MetaDPI/ISPIP-main/Data/input/unbound_cutoff_2_23.csv") as infile_3:
                for tonka in infile_3:
                    ...
                    if protein == protein_name_1:
                        ...
                        print(f"{protein},{fscore},{len(combined_list_final)},{tot_TP}")
                        with open(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/cv_unbound_sets/clustering/results/{predictor}/cluster_4_outfile.csv", "a") as outfile:
                            outfile.write(f"{protein},{fscore},{len(combined_list_final)},{tot_TP}\n")



    folder_cluster_1 = Path(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/cv_unbound_sets/clustering/results/{predictor}/kmeans_cluster_5")
    folder_2 = Path("/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/cv_unbound_sets/alignment/unbound_annotations")
            ...
            with open ("/Users/moshe/Desktop/Research_MetaDPI/ISPIP-main/Data/input/unbound_cutoff_2_23.csv") as infile_3:
                for tonka in infile_3:
                    ...
                    if protein == protein_name_1:
                        ...
                        print(f"{protein},{fscore},{len(combined_list_final)},{tot_TP}")
                        with open(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/cv_unbound_sets/clustering/results/{predictor}/cluster_5_outfile.csv", "a") as outfile:
                            outfile.write(f"{protein},{fscore},{len(combined_list_final)},{tot_TP}\n")



##########CONTINUE FROM HERE -- how should results be analyzed?
