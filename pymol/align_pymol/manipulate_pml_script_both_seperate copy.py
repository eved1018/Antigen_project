...
def image_wrapper(protein_name_bound,chain_name_bound,protein_name_unbound,chain_name_unbound,predicted_res_list_bound,predicted_res_list_unbound,annotated_res_list_unbound,annotated_res_list_bound):
    ...
    filename = f"/Users/moshe/Desktop/Research_Antigen/pymol/results/images_tests/{protein_name_bound}_{protein_name_unbound}.png"
    ...
    super {protein_name_unbound}.{chain_name_unbound}, {protein_name_bound}.{chain_name_bound}
    ...
    file_path = f"/Users/moshe/Desktop/Research_Antigen/pymol/results/scripts_tests/{filename_2}.pml"
