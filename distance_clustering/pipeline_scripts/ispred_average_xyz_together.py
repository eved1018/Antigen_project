...
folder = Path("/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/distance_clustering/metappisp_unbound_coordinates")
for folder_inner in folder.iterdir():
    ...
    for file in sorted(folder_inner.iterdir()):
        ...
        with open (f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/distance_clustering/metappisp_unbound_averaged_results/{folder_inner.name}_avg_results_metappisp.txt", "a") as outfile:
