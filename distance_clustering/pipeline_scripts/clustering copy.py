...
for file in pdb_folder.iterdir():
    with open(file) as pdb_file:
        protein_name = file.name[12:16]

        os.mkdir(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/distance_clustering/annotated_unbound_coordinates/{protein_name}")
        #print(protein_name)
                        ...
                        with open(item) as annotated_file:
                            for line1 in annotated_file:
                                ...
                                if (annotated_res_num == res_num): #change between pred and annotated
                                    ...
                                    with open(f"/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/distance_clustering/annotated_unbound_coordinates/{protein_name}/{res_num}.txt", 'a') as f:
