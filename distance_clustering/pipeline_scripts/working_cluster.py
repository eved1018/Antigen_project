...
def averageXYZ(cluster1, cluster2, data):
    ...
    if protein_name == protein:
        with open("/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/distance_clustering/metappisp_unbound_k_2_clustering.csv", "a") as outfile:
...
folder = Path("/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/distance_clustering/combined_metappisp_unbound_annotated_results")    
