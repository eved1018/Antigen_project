...
folder_pred = Path("/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/distance_clustering/testing_ispred_unbound_separate/cluster_lists/cluster_1")
folder_pred_2 = Path("/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/distance_clustering/testing_ispred_unbound_separate/cluster_lists/cluster_2")
folder_pdb_name = Path("/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/unbound_data/unbound_pdbs")
def test():
    predictors = ['ispred']
    df = pd.read_csv("/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/method_clustering_analysis/test_data_ispred_unbound/unbound_ispred_copy.csv")
    #df.set_index('residue', inplace= True )
    results_path = "/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/distance_clustering/testing_ispred_unbound_separate/images_center"
    code = 1
...
def Main(predictors,df,results_path,code):
    ...
    results_folder = "/Users/moshe/Desktop/Research_Antigen/antigen_project_updated/Antigen_project/distance_clustering/testing_ispred_unbound_separate/images_center"
...
def pml_maker(protein,df,cutoff_csv,folder,path,predictors,results_folder):
    for fire_medic in folder_pdb_name.iterdir():
        if protein == str(fire_medic.name[12:16]):
            
            protein_name = fire_medic.name[19:23]
            chain_name = fire_medic.name[24:25]
