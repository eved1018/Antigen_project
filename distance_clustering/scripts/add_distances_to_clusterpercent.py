...
def cluster():
    ...
    #averageXYZ(cluster1, cluster2, data, protein_name)
...
def getClusterList(ones):
    ...
    percentage_of_predicted_2 = round(((int(predicted_occurences_clu2)/int(total_occurences_clu2))*100),2)
    percentage_of_annotated_2 = round(((int(annotated_occurences_clu2)/int(total_occurences_clu2))*100),2)
    ...
    # percentage_of_predicted_3 = round(((int(predicted_occurences_clu3)/int(total_occurences_clu3))*100),2)
    # percentage_of_annotated_3 = round(((int(annotated_occurences_clu3)/int(total_occurences_clu3))*100),2)

    with open (f"/Users/moshe/Desktop/Research_Antigen/distance_clustering/clustered_residues_k_2/{protein_name}/clu1.txt", "a") as infile_1:
        infile_1.write(string_clu1)
    with open (f"/Users/moshe/Desktop/Research_Antigen/distance_clustering/clustered_residues_k_2/{protein_name}/clu2.txt", "a") as infile_2:
        infile_2.write(string_clu2)
    with open (f"/Users/moshe/Desktop/Research_Antigen/distance_clustering/clustered_residues_k_2/{protein_name}/clu3.txt", "a") as infile_3:
        infile_3.write(string_clu3)    
...
def averageXYZ(cluster1, cluster2, data):
    ...
    print(distance, protein_name)  

def main():
    cluster()
for file in folder.iterdir():
    protein_name = file.name[:4]
    #os.mkdir(f"/Users/moshe/Desktop/Research_Antigen/distance_clustering/clustered_residues_k_2/{protein_name}")
