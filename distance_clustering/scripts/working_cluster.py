...
def averageXYZ(cluster1, cluster2, data):
    ...
    if protein_name == protein:
        with open("/Users/moshe/Desktop/Research_Antigen/distance_clustering/vorffip_bound_k_2_clustering.csv", "a") as outfile:
...
folder = Path("/Users/moshe/Desktop/Research_Antigen/distance_clustering/combined_vorffip_annotated_results")    
